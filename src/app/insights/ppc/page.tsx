...
const points = [
  { title: "Google Ads Management", desc: "Search, Shopping, Display, and Performance Max campaigns engineered for maximum ROAS." },
  { title: "Bing & Emerging Platforms", desc: "Capture high-intent traffic on Microsoft Ads and emerging search platforms at lower CPCs." },
  { title: "Landing Page Optimization", desc: "Conversion-focused landing pages that turn clicks into customers and lower your cost per acquisition." },
  { title: "Bid Strategy & Automation", desc: "Smart bidding strategies and custom scripts that maximize every dollar of your ad spend." },
];
    ...
    <main className="pt-32">
      <div className="site-container px-6 md:px-12 lg:px-24">
        ...
        <motion.p className="mt-6 max-w-xl text-base leading-relaxed" style={{ fontFamily: "var(--font-encode)", color: "var(--foreground-muted)" }} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 0.3 }}>
          High-performance paid search campaigns across Google, Bing, and emerging platforms — built for ROAS, not vanity metrics.
        </motion.p>
